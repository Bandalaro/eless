...
class ElessError(Exception):
    ...
    def __init__(self, message: str, severity: ErrorSeverity = ErrorSeverity.MEDIUM, 
                 suggestions: Optional[list] = None, component: Optional[str] = None):
...
class DependencyError(ElessError):
    ...
    def __init__(self, dependency: str, feature: str, install_command: str):
        ...
        suggestions = [f"Install with: {install_command}", f"Or disable {feature} in configuration"]
...
class ErrorHandler:
    ...
    def _check_dependencies(self):
        ...
        for dep_name, dep_info in dependencies.items():
            try:
                ...
                logger.warning(f"Optional dependency {dep_name} is not available - {dep_info['feature']} will be disabled")
                self.failed_components.add(dep_name)
    
    def handle_dependency_error(self, dependency: str, feature: str, 
                               install_command: str, critical: bool = False) -> bool:
        """
    ...
    def log_error(self, error: Union[ElessError, Exception], 
    ...
    def with_fallback(self, primary_func: Callable, fallback_func: Callable,
        ...
        try:
            ...
            try:
                ...
                logger.error(f"Fallback also failed for {component} {operation}: {fallback_error}")
    ...
    def get_system_health(self) -> Dict[str, Any]:
        ...
        available_count = sum(1 for status in self.component_status.values() 
        ...
        health_score = (available_count + degraded_count * 0.5) / total_components if total_components > 0 else 1.0
