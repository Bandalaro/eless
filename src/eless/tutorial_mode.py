...
def run_tutorial():
    ...
    click.echo()
    click.secho("💡 Think of ELESS as a smart librarian that reads your documents", fg="cyan")
    click.secho("   and remembers them in a way that makes finding information easy.", fg="cyan")
    ...
    click.echo()
    click.secho("💡 Each stage is resumable - if interrupted, ELESS picks up", fg="cyan")
    ...
    click.echo()
    click.secho("💡 The 'go' command is the simplest way to process documents.", fg="cyan")
