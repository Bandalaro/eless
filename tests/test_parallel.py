...
class TestParallelProcessor(unittest.TestCase):
    ...
    def test_process_files_parallel(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = list(self.processor.process_files_parallel(
                test_files,
                mock_processor
            ))
    ...
    def test_process_embeddings_parallel(self):
        test_batches = [
            [f'text_{i}_{j}' for j in range(3)]
            for i in range(4)
        ]
    ...
    def test_adaptive_workers(self):
        ...
        with patch('src.core.resource_monitor.ResourceMonitor.should_throttle_processing') as mock_throttle:
    ...
    def test_thread_vs_process_mode(self):
        ...
        self.assertEqual(thread_processor._get_executor_class().__name__, 'ThreadPoolExecutor')
        ...
        self.assertEqual(process_processor._get_executor_class().__name__, 'ProcessPoolExecutor')
